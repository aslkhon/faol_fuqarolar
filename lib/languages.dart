class Languages {
  static const russian = {
    ...
    'IntroLastLine': '',
    'StepNumber':
        'Введите свой номер телефона, чтобы\nначать пользоваться приложением',
    ...
    'ViewStatusReject':
        'По определенным причинам Ваше предложение отклонено. По вопросам +998 72 342-10-18',
  ...
  static const uzbek = {
    ...
    'StepNumber':
        'Mobil ilovadan foydalanishni boshlash\nuchun telefon raqamingizni kiriting',
